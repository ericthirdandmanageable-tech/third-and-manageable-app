...
import { Phone, Users, Wrench, CheckCircle2 } from 'lucide-react';
    ...
    <div className="p-6 md:p-10 max-w-3xl mx-auto animate-rise">
      ...
      <section className="bg-danger/10 border border-danger/40 rounded-[20px] p-6 mb-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="text-[17px] font-semibold text-text-primary mb-1">In crisis right now?</h2>
            <p className="text-[15px] text-text-secondary leading-relaxed">
              ...
              <span className="font-mono text-text-primary">988</span> for the Suicide &amp; Crisis Lifeline.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-bg-surface rounded-[20px] border border-border-subtle p-6 mb-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-[17px] font-semibold text-text-primary mb-1">Peer support</h2>
            ...
            {!user ? (
              ...
              <p className="flex items-center gap-2 text-[15px] text-volt animate-disclosure">
                <CheckCircle2 className="w-5 h-5" /> We've notified the community. A peer will reach out soon.
              </p>
            )}
          </div>
        </div>
      ...
      <section className="bg-bg-surface rounded-[20px] border border-border-subtle p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-[17px] font-semibold text-text-primary mb-1">Technical support</h2>
            <p className="text-[15px] text-text-secondary mb-4">
            ...
            {!user ? (
              ...
              <p className="flex items-center gap-2 text-[15px] text-volt animate-disclosure">
                <CheckCircle2 className="w-5 h-5" /> Request sent. We'll be in touch.
              </p>
            )}
          </div>
        </div>
