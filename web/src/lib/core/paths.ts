...
export const WORK_PATHS: WorkPath[] = [
    {
        ...
        forum: { title: "The Consulting Circuit", description: "Project seasons, client games, monetizing what you know.", memberCount: 0, activeNow: 0 },
    },
    {
        id: "nine_to_five",
        name: "9–5 / Corporate",
        ...
        forum: { title: "Corporate Athletes", description: "Life in the 9–5. Scoreboards look different here.", memberCount: 0, activeNow: 0 },
    },
    {
        id: "entrepreneurship",
        ...
        forum: { title: "Founders", description: 'The new jersey says "owner." Reality-testing welcome.', memberCount: 0, activeNow: 0 },
    },
    {
        id: "gig",
        name: "Gig Work",
        ...
        forum: { title: "Gig Life", description: "Income now, structure you build yourself.", memberCount: 0, activeNow: 0 },
    },
    {
        id: "overnight",
        ...
        forum: { title: "Night Shift", description: "For the ones wired for odd hours. A bridge, not a dead end.", memberCount: 0, activeNow: 0 },
    },
];
